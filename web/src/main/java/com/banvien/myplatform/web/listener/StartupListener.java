package com.banvien.myplatform.web.listener;
...
import com.banvien.myplatform.web.context.AppContext;
...
public class StartupListener implements ServletContextListener {
    ...
    private void initializeMetaData(ApplicationContext ctx) {
        GlobalMetaDataService globalMetaDataService = (GlobalMetaDataService) ctx.getBean("globalMetaDataService");
        globalMetaDataService.initializeGlobalMetaData();
	}
